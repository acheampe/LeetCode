...
class Solution:
    def findCircleNum(self, isConnected: list[list[int]]) -> int:
        ...
        def findNei(city):
            ...
            for nei in range(n):
                ...
                if seenCity[nei] == False and self.isNei(city, nei, isConnected):
                    findNei(nei)
    ...
    def isNei(self, i, j, isConnected: list[list[int]]) -> bool:
