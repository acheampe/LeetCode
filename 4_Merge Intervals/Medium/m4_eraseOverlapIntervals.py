...
class Solution:
    def eraseOverlapIntervals(self, intervals: List[List[int]]) -> int:
        ...
        # Step 1: sort by x[1] approach to simplify logic
        ...
        while currIndex < len(intervals):
            lastInterval = intervals[fixedIndex]

            if lastInterval[1] > intervals[currIndex][0]:
                eraseMin += 1 # val at currIndex can be erased
                currIndex += 1
