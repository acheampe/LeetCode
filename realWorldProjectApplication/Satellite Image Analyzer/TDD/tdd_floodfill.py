...
class TestFloodfill(unittest.TestCase):
    ...
    def test_floodfill_returns_empty_on_land_cell(self):
        ...
        result = floodfill(1, 1, self.grid, neighbors_4)
    ...
    def test_out_of_bound_floodfill(self):
        expected: list[tuple[int, int]] = []
        result = floodfill(10, 10, self.grid, neighbors_4)
        self.assertEqual(result, 
                            expected, 
    ...
    def test_isolated_water_cell(self):
        ...
        result = floodfill(1, 3, self.grid, neighbors_4)
        self.assertEqual(result, 
                            expected, 
    ...
    def test_two_adjacent_water_cells_neigh_4(self):
        ...
        result = floodfill(3, 3, self.grid, neighbors_4)
    ...
    def test_two_diag_water_cells_neigh_8(self):
        ...
        result = floodfill(5, 1, self.grid, neighbors_8)
        self.assertCountEqual(result, 
                            expected, 
